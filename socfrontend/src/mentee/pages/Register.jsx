...
export default function Register() {
  ...
  const role = isMentor ? "mentor_" : ""; // Dynamically set role
  const baseUrl = process.env.REACT_APP_BACKEND_URL + `/${role}accounts`;
        ...
        <div className="mx-auto max-w-lg">
          ...
          <div className="flex justify-center gap-4 my-4">
            <button
              ...
              onClick={() => {setIsMentor(true);console.log(role,isMentor);}}
            >
              Mentor
            </button>
            <button
              ...
              onClick={() => {setIsMentor(false);console.log(role,isMentor);}}
            >
              Mentee
            </button>
